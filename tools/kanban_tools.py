...
_TASK_FIELDS = tuple(
    "id title body assignee owner status tenant priority workspace_kind workspace_path created_by "
...
_TASK_SUMMARY_FIELDS = tuple(
    "id title assignee owner status priority tenant workspace_kind workspace_path project_id created_by "
