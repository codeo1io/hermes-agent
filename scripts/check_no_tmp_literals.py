...
_BASELINE: dict[str, int] = {
    "CONTRIBUTING.md": 1,
    "acp_adapter/server.py": 1,
    "agent/coding_context.py": 1,
    "agent/copilot_acp_client.py": 2,
    "agent/prompt_builder.py": 2,
    "apps/desktop/README.md": 1,
    "apps/desktop/scripts/perf/gateway_attach_bench.py": 1,
    "apps/desktop/scripts/perf/scenarios/multitab.mjs": 1,
    "apps/desktop/scripts/profile-model-picker.mjs": 1,
    "apps/desktop/scripts/profile-typing-lag.md": 4,
    "apps/desktop/src/app/chat/short-session-hang-repro.tsx": 4,
    ...
    "hermes_cli/subcommands/approvals.py": 1,
    "hermes_constants.py": 1,
    "mini_swe_runner.py": 3,
    "optional-skills/autonomous-ai-agents/blackbox/SKILL.md": 2,
    "optional-skills/autonomous-ai-agents/dynamic-workflow/SKILL.md": 2,
    "optional-skills/autonomous-ai-agents/grok/SKILL.md": 7,
    "optional-skills/autonomous-ai-agents/openhands/SKILL.md": 1,
    "optional-skills/creative/ascii-art/SKILL.md": 2,
    "optional-skills/creative/comfyui/scripts/comfyui_setup.sh": 1,
    "optional-skills/creative/hyperframes/references/troubleshooting.md": 1,
    "optional-skills/creative/meme-generation/EXAMPLES.md": 5,
    "optional-skills/creative/meme-generation/SKILL.md": 9,
    "optional-skills/creative/pixel-art/SKILL.md": 3,
    "optional-skills/creative/pretext/SKILL.md": 1,
    "optional-skills/data-science/jupyter-notebook/SKILL.md": 1,
    "optional-skills/devops/pinggy-tunnel/SKILL.md": 25,
    "optional-skills/gaming/pokemon-player/SKILL.md": 1,
    "optional-skills/mcp/mcp-oauth-remote-gateway/SKILL.md": 2,
    "optional-skills/mlops/pytorch-fsdp/references/common-patterns.md": 1,
    "optional-skills/mlops/pytorch-fsdp/references/other.md": 1,
    "optional-skills/mlops/training/axolotl/references/other.md": 1,
    "optional-skills/payments/stripe-link-cli/SKILL.md": 2,
    "optional-skills/research/bioinformatics/SKILL.md": 4,
    "optional-skills/research/darwinian-evolver/SKILL.md": 5,
    "optional-skills/research/parallel-cli/SKILL.md": 2,
    "optional-skills/research/qmd/SKILL.md": 2,
    "optional-skills/smart-home/openhue/SKILL.md": 2,
    "optional-skills/software-development/ast-grep/references/install.md": 3,
    "optional-skills/software-development/pr-lens/SKILL.md": 1,
    "optional-skills/web-development/har-derived-api-client/SKILL.md": 2,
    "optional-skills/yuanbao/SKILL.md": 1,
    "plugins/disk-cleanup/README.md": 2,
    "plugins/disk-cleanup/__init__.py": 1,
    "plugins/platforms/line/adapter.py": 1,
    "scripts/ci/live_comment.py": 1,
    "scripts/desktop-update/repro.sh": 2,
    "scripts/generate_conformance_vectors.py": 1,
    "scripts/install.sh": 2,
    "scripts/launch_capture_probe.sh": 4,
    "scripts/profile-tui.py": 5,
    "scripts/run_tests_parallel.py": 1,
    "setup-hermes.sh": 2,
    "skills/AGENTS.md": 1,
    "skills/apple/findmy/SKILL.md": 6,
    "skills/autonomous-ai-agents/claude-code/SKILL.md": 3,
    "skills/autonomous-ai-agents/codex/SKILL.md": 6,
    "skills/autonomous-ai-agents/hermes-agent/references/native-mcp.md": 1,
    "skills/autonomous-ai-agents/opencode/SKILL.md": 2,
    "skills/productivity/pdf/references/ocr-extraction.md": 1,
    "skills/software-development/github/references/ci-troubleshooting.md": 1,
    "skills/software-development/github/references/pr-workflow.md": 2,
    "skills/software-development/github/references/repo-management.md": 2,
    "skills/software-development/hermes-agent-skill-authoring/SKILL.md": 1,
    "skills/software-development/inspecting-hermes-desktop-dom/SKILL.md": 2,
    "skills/software-development/node-inspect-debugger/SKILL.md": 7,
    "skills/software-development/python-debugpy/SKILL.md": 1,
    "skills/web/blocked-page-recovery/SKILL.md": 1,
    ...
    "tools/kanban_tools_schemas.py": 3,
    "tools/process_registry.py": 1,
    "tools/read_extract.py": 2,
    "tools/self_repo_guard.py": 2,
    "tools/send_message_tool.py": 1,
    "tools/skills_guard.py": 2,
    "tools/terminal_tool_background.py": 1,
